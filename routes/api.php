...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('setting')->name('setting.')->group(function () {
        ...
        Route::prefix('whatsapp')->name('whatsapp')->group(function () {
            ...
            Route::match(['post', 'put', 'patch'], '/{whatsappOrderSetup}', [WhatsappController::class, 'update']);
            Route::delete('/{whatsappOrderSetup}', [WhatsappController::class, 'destroy']);
        });
...
Route::prefix('frontend')->name('frontend.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    ...
    Route::prefix('contact')->name('contact.')->group(function () {
        Route::post('/', [FrontendContactController::class, 'sendEmail']);
    });
});
