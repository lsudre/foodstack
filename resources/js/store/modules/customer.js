    ...
    actions: {
        ...
        save: function (context, payload) {
            return new Promise((resolve, reject) => {
                ...
                let url = "/admin/customer";
                if (this.state["customer"].temp.isEditing) {
                    method = axios.post;
                    url = `/admin/customer/${this.state["customer"].temp.temp_id}`;
                }
        ...
        destroy: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios
                    .delete(`admin/customer/${payload.id}`)
                    .then((res) => {
                        context
                            .dispatch("lists", payload.search)
                            .then()
        ...
        show: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios
                    .get(`admin/customer/show/${payload}`)
                    .then((res) => {
