    ...
    actions: {
        ...
        save: function (context, payload) {
            return new Promise((resolve, reject) => {
                ...
                let url = "/admin/chef";
                if (this.state["chef"].temp.isEditing) {
                    method = axios.post;
                    url = `/admin/chef/${this.state["chef"].temp.temp_id}`;
                }
        ...
        changePassword: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios
                    .post(
                        `/admin/chef/change-password/${payload.id}`,
                        payload.form
                    )
                    .then((res) => {
                        resolve(res);
        ...
        myOrders: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = `admin/chef/my-order/${payload.id}`;
                if (payload.search) {
