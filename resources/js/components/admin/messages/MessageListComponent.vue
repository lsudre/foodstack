                    ...
                    <div v-for="message in userMessages" :key="message">
                        ...
                        <li class="chat-item chat-user" v-else>
                            ...
                            <div class="chat-group">
                                ...
                                <div class="chat-group-meta">
                                    <span class="chat-meta" dir="ltr" v-if="message.text || message.image">
                                        {{ message.reply_at }}
                                    </span>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        changeImage: function (e) {
            ...
            let fileList = document.querySelector(".chat-footer-data-list");
        ...
        save: function (e) {
            if (typeof this.props.form.text !== "undefined" && this.props.form.text !== "" || this.image != "") {
                ...
                this.$store.dispatch("message/save", fd).then((res) => {
                    ...
                    let fileList = document.querySelector(".chat-footer-data-list");
                    let fileItems = document.querySelectorAll(".chat-footer-data-item");
