        ...
        <div class="db-card db-tab-div active">
            <div class="db-card-header border-none">
                ...
                <div class="db-card-filter">
                    ...
                    <FilterComponent @click.prevent="handleSlide('items-report-filter')" />
            ...
            <div class="table-filter-div" id="items-report-filter">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                            ...
                            <vue-select class="db-field-control f-b-custom-select" id="name" v-model="props.search.name"
                                :options="items" label-by="name" value-by="name" :closeOnSelect="true"
